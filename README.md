# 👩‍💻 Jessica Caetano | Portfólio de Projetos de Dados
...
| [Plano de Recuperação de Lucro](./planoRecuperacaoLucro/) | Análise de vendas com foco em identificar prejuízos da subcategoria Mesas e avaliar como o modal de envio Standard Class afeta a lucratividade. O estudo explora KPIs, cenários de melhoria e insights logísticos para otimizar margens e recuperar desempenho comercial. | Power BI, DAX, Modelagem de Dados, Visual Analytics |
| [Curva ABC para Otimização de Estoque](./curvaABC/) | Análise detalhada da contribuição de cada produto para a receita total, utilizando a metodologia de Curva ABC. O estudo inclui limpeza e validação dos dados em Python, classificação dos itens por impacto financeiro e construção de um dashboard no Power BI para apoiar decisões estratégicas sobre estoque, compras e foco comercial. | Python (Pandas), Power BI, DAX, Modelagem de Dados, Visual Analyticss |
---
